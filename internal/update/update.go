// Package update reports whether a newer prometheus-cli release is available.
//
...
const DefaultEndpoint = "https://api.github.com/repos/AngelMsger/prometheus-cli/releases/latest"

// releasesPage is the human URL shown in the update detail.
const releasesPage = "https://github.com/AngelMsger/prometheus-cli/releases/latest"
...
const EndpointEnv = "PROMETHEUS_RELEASE_API"
