...
const (
	...
	envContextOverride = "PROMETHEUS_CONTEXT"
	// envNoContextHint opts out of the runtime multi-context nudge entirely.
	envNoContextHint = "PROMETHEUS_CLI_NO_CONTEXT_HINT"
)
...
//   - the context was selected explicitly (--use-context / PROMETHEUS_CONTEXT),
//   - a human is at the terminal (stderr is a TTY),
//   - the command is a setup/meta command or a non-runnable group, or
//   - the nudge is opted out (PROMETHEUS_CLI_NO_CONTEXT_HINT).
//
