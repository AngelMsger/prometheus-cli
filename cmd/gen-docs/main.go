// Command gen-docs renders the prometheus-cli command tree into reference
...
const pagesURL = "https://angelmsger.github.io/prometheus-cli/cli/"

// repoURL is the GitHub repository.
const repoURL = "https://github.com/AngelMsger/prometheus-cli"
...
func writeReadme(mods []module) error {
	var b strings.Builder
	b.WriteString("# prometheus-cli command reference\n\n")
...
<title>prometheus-cli — CLI reference</title>
<link rel="icon" type="image/png" href="../favicon.png">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600&family=IBM+Plex+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
<link rel="stylesheet" href="../style.css">
<link rel="canonical" href="https://angelmsger.github.io/prometheus-cli/cli/">
</head>
<body>
<nav class="nav">
  <div class="nav-inner">
    <a class="brand" href="../">prometheus-cli</a>
    <div class="nav-links">
      <a href="../">Home</a>
...
<footer class="footer">
  <div class="wrap">
    <span class="brand-foot">prometheus-cli — MIT License</span>
